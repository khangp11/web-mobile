                    ...
                    <div className='absolute ml-36 flex'>
                        ...
                        >
                            <div className="bg-slate-50 w-20 h-20 rounded-full relative">
                                <div className="text-white bg-red-800 w-16 h-16 rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                                ...
                                {cartList.length > 0 ? (
                                    <button className='bg-orange-600 rounded-full ml-14 mt-2 w-8 h-8 text-white absolute'>
                                        {cartList.length}
                                    </button>
                                ) : null}
                            </div>
